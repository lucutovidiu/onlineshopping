...
const SizeComponent = ({ componentName, componentValues, classes, openComponentMenu, menuIsOpen }) => {
    // const [menuIsOpen, setMenuIsOpen] = React.useState(false);
    // console.log(componentValues)
    return (
        <div className={classes.default_custom_component}>
            <div onClick={() => openComponentMenu("SizeComponent")} className={`btnWrapper  ${menuIsOpen ? classes.addBorders : ""}`}>
                {componentName.en}
